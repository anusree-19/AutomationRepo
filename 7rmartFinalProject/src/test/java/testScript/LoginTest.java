...
public class LoginTest extends Base {
	...
	@Test(description = "Verifying User is able to login with Valid credentials", priority = 1, groups = { "smoke" })
	...
	@Test(description = "Verifying user is able to login with Invalid username and Valid password", priority = 4, groups = {
			"smoke" })
	...
	public void verifyUserCanSucessfullyLoginWithInvalidUsernameInvalidpwd(String username, String password)
			throws IOException {
	...
	// retryAnalyzer =retry.Retry.class : applied inside @Test
}
